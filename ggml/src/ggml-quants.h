...
void ggml_axpy_q4_0_q8_0(const int n, const void * GGML_RESTRICT vx, const void * GGML_RESTRICT vy, const void * GGML_RESTRICT vz, int8_t alpha, ggml_fp16_t scale);
